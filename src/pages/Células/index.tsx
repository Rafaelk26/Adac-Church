    ...
    return(
        <>
            <ContainerHeader>
                ...
                <div className='w-full h-24 flex justify-center flex-col mt-1
                md:justify-between md:flex-row'>
                    {/* Subtitle */}
                    <p className='w-2/6 h-full font-normal text-xl inter'>
                        Localize a célula mais perto de sua residência e sinta o agir de Deus bem pertinho de sua casa!
                    </p>
                    {/* Select bairro */}
                    <div className='w-2/3 h-max flex justify-end mt-3'>
                        <select
                        ...
                        value={selectedNeighborhood}>
                            ...
                            <option value="Jardim das Flecheiras">Jardim das Flecheiras</option>
            ...
            <ContainerMain>
                <div className='mt-56 flex flex-grow flex-wrap gap-5 mb-10'>
                    {filteredCells.length === 0 ? ( <p className="text-center text-lg w-full">Nenhuma célula encontrada</p>) : (
