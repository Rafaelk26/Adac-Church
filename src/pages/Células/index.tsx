    ...
    return(
        <>
            ...
            <div className='w-full h-24 flex items-center flex-col mt-40
                sm:mt-36
                md:justify-between md:flex-row md:mt-24'>
                    {/* Subtitle */}
                ...
                md:mt-8 md:justify-center'>
                    {filteredCells.length === 0 ? ( <p className="text-center text-lg w-full h-full flex justify-center ">Nenhuma célula encontrada</p>) : (
